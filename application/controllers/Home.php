	...
	public function tambah_kontak($param=NULL){
		if($param=='kirim_kontak'){
			...
			if(!empty($post['name_testi']) && !empty($post['email_testi']) && !empty($post['testi'])){
				...
				<table width="349" cellspacing="0" cellpadding="0" border="0"> <tr> <td style="vertical-align: top; text-align:left;color:#000000;font-size:12px;font-family:helvetica, arial;; text-align:left"> <span><span style="margin-right:5px;color:#000000;font-size:15px;font-family:helvetica, arial">Bahyu Sanciko</span> </span> <br><br><br> <table cellpadding="0" cellpadding="0" border="0"><tr><td style="padding-right:5px"><a target="_blank" href="https://instagram.com/bahyusanciko" style="display: inline-block"><img width="40" height="40" src="https://s1g.s3.amazonaws.com/9bfb4e4bee7656580b2a5d1a7c18c355.png" alt="Instagram" style="border:none"></a></td><td style="padding-right:5px"><a target="_blank" href="https://wa.me/+6289682261128" style="display: inline-block"><img width="40" height="40" src="https://s1g.s3.amazonaws.com/370c956cb92063dfbc131b5393411f78.png" alt="WhatsApp" style="border:none"></a></td><td style="padding-right:5px"><a target="_blank" href="https://github.com/bahyusanciko" style="display: inline-block"><img width="40" height="40" src="https://s1g.s3.amazonaws.com/b0cd8b19b62e6e47e490fa93d073d360.png" alt="Github" style="border:none"></a></td><td style="padding-right:5px"><a target="_blank" href="https://facebook.com/bahyusanciko" style="display: inline-block"><img width="40" height="40" src="https://s1g.s3.amazonaws.com/29bbe451b56a1f277d73dcff49b75935.png" alt="Facebook" style="border:none"></a></td><td style="padding-right:5px"><a target="_blank" href="https://twitter.com/bhysnck" style="display: inline-block"><img width="40" height="40" src="https://s1g.s3.amazonaws.com/dabe53a8cd7f2fc1b45e84fd559d8c0a.png" alt="Twitter" style="border:none"></a></td><td style="padding-right:5px"><a target="_blank" href="https://linkedin.com/in/bahyu-sanciko-a52654150/" style="display: inline-block"><img width="40" height="40" src="https://s1g.s3.amazonaws.com/4cb73cdd183cb4316e8462d2caf06656.png" alt="LinkedIn" style="border:none"></a></td></tr></table><a target="_blank" href="http://bahyusanciko.xyz" style="text-decoration:none;color:#3388cc">bahyusanciko.xyz</a> </td> </tr> </table> <table width="349" cellspacing="0" cellpadding="0" border="0" style="margin-top:10px"> <tr> <td style="text-align:left;color:#aaaaaa;font-size:10px;font-family:helvetica, arial"><p>Hello World</p></td> </tr> </table>';
				$config = Array(
		      	'protocol' 	=> 'smtp',
		      	'smtp_host' => 'ssl://smtp.googlemail.com',
		      	'smtp_port' => 465,
		      	'smtp_user' => 'cbahyu@gmail.com', 
		      	'smtp_pass' => '', 
		      	'mailtype' 	=> 'html',
		      	'charset' 	=> 'iso-8859-1',
			    );
