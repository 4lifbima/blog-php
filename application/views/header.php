      ...
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="container">
          ...
          <div class="navbar-header d-flex align-items-center justify-content-between">
            <!-- Navbar Brand --><a href="<?php echo base_url() ?>" class="navbar-brand">Bahyu Sanciko Blog</a>
            <!-- Toggle Button-->
          ...
          <div id="navbarcollapse" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item"><a href="<?php echo base_url().'home/kontak'?>" class="nav-link ">Contact</a>
              </li>
              <li class="nav-item"><a href="<?php echo base_url().'home/tentang'?>" class="nav-link ">About</a>
              </li>
            </ul>
