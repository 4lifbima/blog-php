...
<!-- Hero Section-->
<section style="background: url(<?php echo base_url('assets/img/bahyu.jpg') ?>); background-size: cover; background-position: center center" class="hero">
	<div class="container">
		<div class="row">
			<div class="col-lg-7">
				<h1 class="promo-block-title">Bahyu Sanciko</h1>
				<p class="promo-block-text">Software Engineer</p>
			</div>
			</div><a href=".posts-listing" class="continue link-scroll"><i class="fa fa-long-arrow-down"></i> Scroll Down My Blog</a>
		</div>
	</section>
	<div class="container">
		<div class="row">
			...
			<main class="posts-listing col-lg-8">
				...
				My Blog | Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>StokCoding.com</a>
